        ...
        <div className="">
          ...
          >
            ...
            <div className="flex justify-between">
              ...
              <div className="flex h-full pt-10 float-end gap-3">
                <Link to={"/admin/data_user"} className="p-4 py-2 w-24 h-10 rounded bg-red">
                  Kembali
                </Link>
                <button type="submit" className="p-4 py-2 w-24 h-10 rounded bg-blue">
                  Kirim
                </button>
              </div>
            </div>
