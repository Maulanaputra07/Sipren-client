            ...
            <ul>
              ...
              {isAdmin && (
                <>
                  ...
                  <li>
                    <Link to="mapel" className={`group flex item-center gap-3 transition-all py-2 duration-300 ease-in-out ${pathname.includes("/kelas") ? "active py-2 rounded-lg bg-white" : "py-2 hover:bg-white hover:rounded-lg"}`}>
